...
export const metadata = { title: "End User License Agreement — Founder ERP" };
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-8 prose prose-sm dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 space-y-6">
          ...
          <section>
            ...
            <p>This End User License Agreement (&ldquo;Agreement&rdquo;) is a legal agreement between you (&ldquo;User&rdquo;) and Your Company LLC (&ldquo;Founder ERP,&rdquo; &ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;) governing your access to and use of the Founder ERP platform (the &ldquo;Platform&rdquo;). By accessing or using the Platform, you agree to be bound by this Agreement. If you do not agree, do not access or use the Platform.</p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-2">2. License Grant</h2>
            <p>Subject to the terms of this Agreement, Founder ERP grants you a limited, non-exclusive, non-transferable, revocable license to access and use the Platform solely for your authorized internal business purposes. This license does not include the right to sublicense, resell, or otherwise transfer access to the Platform to any third party.</p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-2">3. Access and Account Security</h2>
            <p>Access to the Platform is granted by Founder ERP administrators. You are responsible for maintaining the confidentiality of your login credentials and for all activities that occur under your account. You agree to notify Founder ERP immediately of any unauthorized use of your account. Founder ERP reserves the right to terminate or suspend access at any time, with or without cause.</p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">Data you upload or generate through your use of the Platform remains your property. You grant Founder ERP a limited license to use such data solely for the purpose of providing and improving the Platform.</p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-2">6. Confidentiality</h2>
            <p>The Platform may provide access to confidential business information, research data, financial models, and proprietary analyses. You agree to keep all such information strictly confidential and not to disclose it to any third party without prior written authorization from Founder ERP.</p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-2">7. Disclaimer of Warranties</h2>
            <p>THE PLATFORM IS PROVIDED &ldquo;AS IS&rdquo; AND &ldquo;AS AVAILABLE&rdquo; WITHOUT WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, OR NON-INFRINGEMENT. FOUNDER ERP DOES NOT WARRANT THAT THE PLATFORM WILL BE UNINTERRUPTED, ERROR-FREE, OR FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS.</p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-2">8. Limitation of Liability</h2>
            <p>TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, FOUNDER ERP SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING LOSS OF PROFITS, DATA, OR GOODWILL, ARISING OUT OF OR IN CONNECTION WITH YOUR USE OF OR INABILITY TO USE THE PLATFORM, EVEN IF FOUNDER ERP HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. FOUNDER ERP&rsquo;S TOTAL CUMULATIVE LIABILITY TO YOU SHALL NOT EXCEED THE AMOUNTS PAID BY YOU TO FOUNDER ERP IN THE TWELVE (12) MONTHS PRECEDING THE CLAIM.</p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-2">9. Termination</h2>
            <p>This Agreement is effective until terminated. Founder ERP may terminate your access immediately and without notice if you breach any term of this Agreement. Upon termination, you must cease all use of the Platform. Sections 5, 6, 7, 8, and 10 survive termination.</p>
          </section>
          ...
          <section>
            ...
            <p>Founder ERP reserves the right to modify this Agreement at any time. We will notify users of material changes by updating the &ldquo;Last updated&rdquo; date above. Continued use of the Platform after changes take effect constitutes acceptance of the revised Agreement.</p>
          </section>
